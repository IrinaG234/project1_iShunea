            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
              <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                ...
                <div className="relative w-full h-64 bg-gray-100 rounded-lg">
                  <Image
                    src="/hero.png" // Înlocuiește cu {car.image} dacă ai
                ...
                <div className="flex gap-3">
                  <div className="flex-1 relative w-full h-24 bg-blue-100 rounded-lg">
                    <Image src="/hero.png" alt="thumbnail 1" fill className="object-contain" />
                  </div>
                  <div className="flex-1 relative w-full h-24 bg-blue-100 rounded-lg">
                    <Image src="/hero.png" alt="thumbnail 2" fill className="object-contain" />
                  </div>
                  <div className="flex-1 relative w-full h-24 bg-blue-100 rounded-lg">
                    <Image src="/hero.png" alt="thumbnail 3" fill className="object-contain" />
                  </div>
                </div>
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <div className="mt-3 flex flex-wrap gap-4">
                    {Object.entries(car).map(([key, value]) => {
                      // Ignoră cheile care nu sunt relevante pentru afișare
